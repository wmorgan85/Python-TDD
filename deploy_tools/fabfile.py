...
REPO_URL = 'https://github.com/wmorgan85/Python-TDD.git'
...
def _update_virtualenv(source_folder):
    if not exists('/home/pi/miniconda/envs/py34/bin/pip'):
        run('conda create --name py34 python=3.4')
    run('source activate py34')
